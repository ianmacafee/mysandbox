...
/*
 */
static void Location_GPS_CB_xact_to_2_1( Location_GPS *, const Escher_xtUMLEvent_t * const );
static void
Location_GPS_CB_xact_to_2_1( Location_GPS * self, const Escher_xtUMLEvent_t * const event )
{
  /* GPS::activate() */
...
/*
 */
static void Location_GPS_CB_xact_to_2_2( Location_GPS *, const Escher_xtUMLEvent_t * const );
static void
Location_GPS_CB_xact_to_2_2( Location_GPS * self, const Escher_xtUMLEvent_t * const event )
{
  Location_GPS * gps=0;
  /* SELECT any gps FROM INSTANCES OF GPS */
  XTUML_OAL_STMT_TRACE( 1, "SELECT any gps FROM INSTANCES OF GPS" );
...
static const Escher_SEMcell_t Location_GPS_CB_StateEventMatrix[ 2 + 1 ][ 3 ] = {
  ...
  static const StateAction_t Location_GPS_CB_xacts[ 2 ] = {
    (StateAction_t) Location_GPS_CB_xact_to_2_1,
    (StateAction_t) Location_GPS_CB_xact_to_2_2
  };
