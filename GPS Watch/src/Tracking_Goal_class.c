...
/*
 */
static void Tracking_Goal_xact_to_1_1( Tracking_Goal *, const Escher_xtUMLEvent_t * const );
static void
Tracking_Goal_xact_to_1_1( Tracking_Goal * self, const Escher_xtUMLEvent_t * const event )
{
...
static const Escher_SEMcell_t Tracking_Goal_StateEventMatrix[ 3 + 1 ][ 3 ] = {
  ...
  static const StateAction_t Tracking_Goal_xacts[ 1 ] = {
    (StateAction_t) Tracking_Goal_xact_to_1_1
  };
