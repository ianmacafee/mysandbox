...
/*
 */
static void UI_TestCase_xact_to_2_1( UI_TestCase *, const Escher_xtUMLEvent_t * const );
static void
UI_TestCase_xact_to_2_1( UI_TestCase * self, const Escher_xtUMLEvent_t * const event )
{
...
static const Escher_SEMcell_t UI_TestCase_StateEventMatrix[ 2 + 1 ][ 3 ] = {
  ...
  static const StateAction_t UI_TestCase_xacts[ 1 ] = {
    (StateAction_t) UI_TestCase_xact_to_2_1
  };
