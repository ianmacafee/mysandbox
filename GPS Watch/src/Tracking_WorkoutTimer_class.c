...
/*
 */
static void Tracking_WorkoutTimer_xact_to_2_1( Tracking_WorkoutTimer *, const Escher_xtUMLEvent_t * const );
static void
Tracking_WorkoutTimer_xact_to_2_1( Tracking_WorkoutTimer * self, const Escher_xtUMLEvent_t * const event )
{
  /* self.activate() */
...
/*
 */
static void Tracking_WorkoutTimer_xact_to_2_2( Tracking_WorkoutTimer *, const Escher_xtUMLEvent_t * const );
static void
Tracking_WorkoutTimer_xact_to_2_2( Tracking_WorkoutTimer * self, const Escher_xtUMLEvent_t * const event )
{
...
/*
 */
static void Tracking_WorkoutTimer_xact_to_2_3( Tracking_WorkoutTimer *, const Escher_xtUMLEvent_t * const );
static void
Tracking_WorkoutTimer_xact_to_2_3( Tracking_WorkoutTimer * self, const Escher_xtUMLEvent_t * const event )
{
  /* self.activate() */
  XTUML_OAL_STMT_TRACE( 1, "self.activate()" );
  Tracking_WorkoutTimer_op_activate( self );
...
/*
 */
static void Tracking_WorkoutTimer_xact_to_3_4( Tracking_WorkoutTimer *, const Escher_xtUMLEvent_t * const );
static void
Tracking_WorkoutTimer_xact_to_3_4( Tracking_WorkoutTimer * self, const Escher_xtUMLEvent_t * const event )
{
  /* self.deactivate() */
...
/*
 */
static void Tracking_WorkoutTimer_xact_to_2_5( Tracking_WorkoutTimer *, const Escher_xtUMLEvent_t * const );
static void
Tracking_WorkoutTimer_xact_to_2_5( Tracking_WorkoutTimer * self, const Escher_xtUMLEvent_t * const event )
{
  Tracking_TrackLog * trackLog=0;
...
static const Escher_SEMcell_t Tracking_WorkoutTimer_StateEventMatrix[ 3 + 1 ][ 3 ] = {
  ...
  static const StateAction_t Tracking_WorkoutTimer_xacts[ 5 ] = {
    (StateAction_t) Tracking_WorkoutTimer_xact_to_2_1,
    (StateAction_t) Tracking_WorkoutTimer_xact_to_2_2,
    (StateAction_t) Tracking_WorkoutTimer_xact_to_2_3,
    (StateAction_t) Tracking_WorkoutTimer_xact_to_3_4,
    (StateAction_t) Tracking_WorkoutTimer_xact_to_2_5
  };
