...
HeartRateMonitor_HeartRateMonitor_CB_act2( HeartRateMonitor_HeartRateMonitor * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  /* ASSIGN monitor.recentHeartRate = ( monitor.recentHeartRate + 1 ) */
  XTUML_OAL_STMT_TRACE( 1, "ASSIGN monitor.recentHeartRate = ( monitor.recentHeartRate + 1 )" );
  monitor->recentHeartRate = ( monitor->recentHeartRate + 1 );
}

/*
 */
static void HeartRateMonitor_HeartRateMonitor_CB_xact_to_2_1( HeartRateMonitor_HeartRateMonitor *, const Escher_xtUMLEvent_t * const );
static void
HeartRateMonitor_HeartRateMonitor_CB_xact_to_2_1( HeartRateMonitor_HeartRateMonitor * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  /* ASSIGN monitor.recentHeartRate = 50 */
  XTUML_OAL_STMT_TRACE( 1, "ASSIGN monitor.recentHeartRate = 50" );
  ...
  /* ASSIGN monitor.timer = TIM::timer_start_recurring(event_inst:timeout, microseconds:( HeartRateSamplingPeriod * 1000000 )) */
  XTUML_OAL_STMT_TRACE( 1, "ASSIGN monitor.timer = TIM::timer_start_recurring(event_inst:timeout, microseconds:( HeartRateSamplingPeriod * 1000000 ))" );
  monitor->timer = TIM_timer_start_recurring( (Escher_xtUMLEvent_t *)timeout, ( 3 * 1000000 ) );
}

/*
 */
static void HeartRateMonitor_HeartRateMonitor_CB_xact_to_1_2( HeartRateMonitor_HeartRateMonitor *, const Escher_xtUMLEvent_t * const );
static void
HeartRateMonitor_HeartRateMonitor_CB_xact_to_1_2( HeartRateMonitor_HeartRateMonitor * self, const Escher_xtUMLEvent_t * const event )
{
...
static const Escher_SEMcell_t HeartRateMonitor_HeartRateMonitor_CB_StateEventMatrix[ 2 + 1 ][ 3 ] = {
  ...
  static const StateAction_t HeartRateMonitor_HeartRateMonitor_CB_xacts[ 2 ] = {
    (StateAction_t) HeartRateMonitor_HeartRateMonitor_CB_xact_to_2_1,
    (StateAction_t) HeartRateMonitor_HeartRateMonitor_CB_xact_to_1_2
  };
